document.addEventListener('DOMContentLoaded', ()=>{
  document.querySelectorAll('[js-expand__layout]').forEach((elm)=>{
    elm.addEventListener('click',(target)=>{
      ...
      .finally( () =>{
        ...
        if( document.querySelectorAll('.product-listblock__container_cv').length > 0 ){
          document.querySelector('.product-listblock__container_cv').lastElementChild.querySelector('.img_pro_list_inner').innerHTML = `<img loading="eager" src="https://cdn.shopify.com/s/files/1/0267/3351/0727/files/Quantity_Detail_-_Giftx3-min.png?v=1734948670">`;
        }
  ...
  document.querySelector('.linkImageText').addEventListener('click', function (e) {
    e.preventDefault();
    const clinicalDrawer = document.getElementById('clinicalSideDrawer');
    // clinicalDrawer.querySelector('.drawer__body').scroll(0,0);
    document.documentElement.style.setProperty('--clinical-trial-padding-top', '0px');
