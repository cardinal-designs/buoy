...
function addToCart(trigger) {
    ...
    bundleProductListInputs.forEach(function(bundleProductInput){
        ...
        if(parseInt(bundleProductInput.value) > 0) {
          let sellingId = null;
          console.log(document.querySelector(`.lsg-bundle-interval-select-pod-bottom [data-product="${bundleProductInput.dataset.productId}"] [value="20"][daya-variant-id="${bundleProductInput.dataset.product}"]`).dataset)
