...
// People
$('.people-slider__drink-slider').each(function(index) {
  var drinkSliderClass = '.people-slider__drink-slider--' + (index + 1);
  var peopleSliderClass = '.people-slider__people-slider--' + (index + 1);
  var arrowsClass = '.people-slider__arrows--' + (index + 1);
