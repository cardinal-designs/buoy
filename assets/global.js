...
$('.people-slider__people-slider--3').slick({
  ...
  variableWidth: true,
  infinite: false,
  prevArrow: '<button type="button" class="people-slider__arrows--3 slick-prev"></button>',
  nextArrow: '<button type="button" class="people-slider__arrows--3 slick-next"></button>',
