...
//     modalContent.prepend(newMediaModal);
  ...
  toggleAddButton(disable = true, text, modifyClass = true, price) {
    ...
    let addToCartText = `aaaaAdd to Cart — ${variantJson[this.currentVariant.id].price}`;
    if(subscriptionOption){
      if(subscriptionOption.value == "purchaseTypeSubscription"){
        ...
        addToCartText = `bbbAdd to Cart — ${variantJson[this.currentVariant.id].subscription_price}`;
